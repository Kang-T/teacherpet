...
| 🎩 **꾸미기 59가지** | 모자 18 · 지붕 8 · 마당 장식 25 · 바닥 8. 추석·핼러윈·크리스마스·설날에만 파는 철 한정 물건도 있습니다. 치운 장식은 보관함에 들어가 언제든 다시 놓을 수 있습니다. 뽑기는 없고, 돈으로 닭이 강해지지 않습니다. |
| 🤝 **친구 닭 놀러 오기** | 내 닭의 짧은 코드(예: `초코-3F7K`)를 친구에게 불러 주면, 그 닭이 친구 마당에 하루 놀러 갑니다. 서버를 거치지 않습니다. |
...
터치 화면에서는 손가락 하나가 마우스처럼 움직입니다. 오른쪽 클릭 대신 **모이통을 꾹** 누르면 사료가 바뀌고,
**두 번 톡톡**은 휘파람, **두 손가락 벌리기**는 확대, **두 손가락 위아래**는 시점입니다.

---

## ⏱ 붙잡아 두지 않습니다

쉬는 시간에 잠깐 켜서 닭이 잘 있는지 보고, 챙겨 주고, 쓰다듬고 가는 게임입니다.

1. 오래 한다고 더 빨리 자라거나 더 얻지 않습니다. 할 수 있는 양은 하루 한도가 있습니다.
2. 오늘 할 일을 다 하면 할머니가 "내일 또 보러 오렴" 하고 알려 줍니다.
3. 연속 출석 보너스, 알림, 뽑기, 순위가 없습니다. 주말·방학에는 시간이 멈춥니다.
4. 화면을 켜 둔 채 아무도 안 보면 닭들이 자러 들어갑니다 💤
